...
class LogControllerTest {
    ...
    void actionsPopulatesActionLogScreen() {
        ...
        String viewName = logController.actions(model);
    ...
    void mailPopulatesMailLogScreen() {
        ...
        String viewName = logController.mail(model);
    ...
    void searchPopulatesSearchLogScreen() {
        ...
        String viewName = logController.search(model);
    ...
    void notificationsPopulatesNotificationLogScreen() {
        ...
        String viewName = logController.notifications(model);
